...
export function bigIntMod(_a: number | bigint, _n: number | bigint): bigint {
...
export function gcdExtended(_a: number | bigint, _b: number | bigint): bigint[] {
...
export function modInverse(_a: number | bigint, _m: number | bigint): bigint {
...
export function modDivide(_a: number | bigint, _b: number | bigint, _m: number | bigint): bigint {
